...
import { FrameworkCategories, FrameworkNames } from '../../../models/compliance';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule,DropdownModule,TableModule,CalendarModule,ReactiveFormsModule,ProgressSpinnerModule,InputTextModule,CheckboxModule],
...
export class FrameworkComponent {
  ...
  constructor(private fb: FormBuilder , private toastr: ToastrService , private complianceService: ComplianceService , private datePipe: DatePipe , private frameworkService: FrameworkService , private cd:ChangeDetectorRef){
  ...
  loadData(event?: TableLazyLoadEvent,filters?:any) {
    ...
    this.frameworkService.getFrameworksPaginated(page, size, this.appliedFilters).subscribe({
      next: (res: any) => {
